    ...
    <div className="min-h-screen">
      <section className="section-padding bg-charcoal-ink">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="heading-primary text-brass-accent mb-6">Analytics & Reporting</h1>
          <p className="body-large text-ivory-mist max-w-4xl mx-auto">Transform data into actionable insights with comprehensive analytics and reporting that drives smarter marketing decisions.</p>
        </div>
      </section>
      <section className="section-padding bg-gradient-to-br from-ivory-mist to-signal-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {['Custom Analytics Dashboards', 'Performance Tracking & Monitoring', 'Conversion Rate Optimisation', 'Competitive Intelligence', 'ROI Analysis & Attribution', 'Strategic Recommendations'].map((item, i) => (
